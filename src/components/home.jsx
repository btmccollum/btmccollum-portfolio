        ...
        <Row>
          ...
          <Col xs={8} className="socialsCol">
            <div className="socials">
              ...
              <a href="https://www.github.com/btmccollum" target="_blank" rel="noopener noreferrer ">
                <FontAwesomeIcon icon={["fab", "github-square"]} size="3x" />
              </a>
              <span className="divider" />
              <a href="https://www.linkedin.com/in/btmccollum/" target="_blank" rel="noopener noreferrer ">
                <FontAwesomeIcon icon={["fab", "linkedin"]} size="3x" />
              </a>
              <span className="divider" />
              <a href="https://www.twitter.com/btmccollum" target="_blank" rel="noopener noreferrer">
